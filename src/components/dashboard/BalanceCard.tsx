  ...
  return (
    ...
    <Card className="bg-transparent border-0 shadow-none">
      <CardContent className="p-8 flex flex-col items-center justify-center min-h-[180px]">
        ...
        <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-md px-4 py-1.5 rounded-full text-sm font-medium text-slate-600 dark:text-slate-300 mb-6 flex items-center gap-2 border border-slate-200 dark:border-slate-700">
           @jadonamite
        </div>

        {/* Balance Section */}
        <div className="text-center">
          <p className="text-slate-500 dark:text-slate-400 text-sm font-medium mb-2">Total Balance</p>
